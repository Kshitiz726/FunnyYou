...
/// The four steps of the flow, illustrated in a phone mockup.
///
/// This used to be bolted onto the end of the first-run welcome screen.
/// It is not first-run material: someone opening the app for the first
/// time wants to start, not read a tour. It lives behind
/// **Me > How it works** now, for the people who do want it.
class HowItWorksScreen extends StatefulWidget {
  const HowItWorksScreen({super.key, required this.onFinished});
